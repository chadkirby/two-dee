...
var NumberPair, PI, Point2d, abs, atan2, cos, fuzzyEqual, hypot, isNumber, max, min, p, roundTo, sin, sqrt, util,
...
Point2d = (function(_super) {
  ...
  Point2d.quacksLikeAPoint = function(obj) {
    if (obj instanceof Point2d || (obj.asPoint != null) || isNumber(obj.x, obj.y) || isNumber(obj[0], obj[1])) {
      return true;
    }
    return false;
  };
