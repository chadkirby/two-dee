...
Point2d = (function(superClass) {
  var defProp;

  extend(Point2d, superClass);
  ...
  defProp({
    'rho, magnitude': {
      ...
      set: function(new_rho) {
        var ref;
        return ref = this.asPolar().rho_(new_rho).asPoint(), this.x = ref.x, this.y = ref.y, ref;
      }
    },
    'theta, angle': {
      get: (function() {
      ...
      set: (function(new_theta) {
        var ref;
        return ref = this.asPolar().theta_(new_theta).asPoint(), this.x = ref.x, this.y = ref.y, ref;
      })
    },
    'thetaDeg, angleDeg': {
      get: (function() {
  ...
  Point2d.prototype.plus = function(aPoint) {
    var ref;
    aPoint = (ref = this.constructor)["new"].apply(ref, arguments);
  ...
  Point2d.prototype.scaleAbout = function() {
    var aPoint, factor, ref;
    factor = arguments[0], aPoint = 2 <= arguments.length ? slice.call(arguments, 1) : [];
    aPoint = (ref = this.constructor)["new"].apply(ref, aPoint);
    if (this.isEq(aPoint)) {
      return this;
    }
  ...
  Point2d.prototype.rotateAbout = function() {
    var aPoint, angle, ref;
    angle = arguments[0], aPoint = 2 <= arguments.length ? slice.call(arguments, 1) : [];
    aPoint = (ref = this.constructor)["new"].apply(ref, aPoint);
  ...
  Point2d.prototype.distTo = function(aPoint) {
    var dx, dy, ref;
    ref = this.minus.apply(this, arguments), dx = ref[0], dy = ref[1];
    return hypot(dx, dy);
  };
