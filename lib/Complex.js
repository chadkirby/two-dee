...
Complex = (function(superClass) {
  ...
  defProp({
    'magnitude, rho': {
      ...
      set: function(new_real) {
        var ref;
        return ref = this.asPolar().rho_(new_real).asComplex(), this.real = ref.real, this.imag = ref.imag, ref;
      }
    },
    'angle, phase, theta': {
      get: (function() {
      ...
      set: function(new_theta) {
        var ref;
        return ref = this.asPolar().theta_(new_theta).asComplex(), this.real = ref.real, this.imag = ref.imag, ref;
      }
    }
  });
  ...
  Complex.prototype.plus = function(aNumber) {
    var ref;
    aNumber = (ref = this.constructor)["new"].apply(ref, arguments);
