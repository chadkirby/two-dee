...
var PI, Point, Rect, abs, atan2, cos, exec, fuzzyEqual, hypot, i, isNumber, j, max, min, r, roundTo, sin, sqrt, square, util;
...
Rect = (function() {
  ...
  defProp({
    ...
    leftCenter: {
      get: function() {
        return Point["new"](this.left, this.center.y);
      }
    },
    rightCenter: {
      get: function() {
        return Point["new"](this.right, this.center.y);
      }
    },
    topCenter: {
      get: function() {
        return Point["new"](this.center.x, this.top);
      }
    },
    bottomCenter: {
      get: function() {
        return Point["new"](this.center.x, this.bottom);
      }
    },
    type: {
      get: function() {
  ...
  Rect.prototype.closestShapeSegment = function(aPoint) {
    var closestSegment, dist, key, minDist, pt, ref, segment;
    aPoint = Point["new"].apply(Point, arguments);
    minDist = Infinity;
    closestSegment = null;
  ...
  Rect.prototype.contains = function(aPoint) {
    ...
    return ((this.left <= x && x <= this.right)) && ((min(this.bottom, this.top) <= y && y <= max(this.bottom, this.top)));
  };

  Rect.prototype.includes = function(aRect) {
    aRect = Rect["new"](aRect);
    switch (false) {
      case !(aRect.right > this.right):
        return false;
      case !(aRect.bottom > this.bottom):
        return false;
      case !(aRect.left < this.left):
        return false;
      case !(aRect.top < this.top):
        return false;
      default:
        return true;
    }
  ...
  Rect.prototype.intersects = function(aRect) {
    aRect = Rect["new"](aRect);
    switch (false) {
      case !(aRect.right < this.left):
        return false;
      case !(aRect.bottom < this.top):
        return false;
      case !(aRect.left > this.right):
        return false;
      case !(aRect.top > this.bottom):
        return false;
      default:
        return true;
    }
  ...
  Rect.prototype.positionComparedTo = function(aRect, opts) {
    var above, below, leftOf, otherPt, pt, rightOf, xAligned, yAligned;
    if (opts == null) {
      opts = {};
    }
    aRect = Rect["new"](aRect);
    if (opts.referencePoint == null) {
  ...
  Rect["new"] = function(arg0, arg1, arg2, arg3) {
    var hgt, p0, p1, ref, ref1, ref2, ref3, wid;
    switch (false) {
      ...
      case !Point.quacksLikeAPoint(arg0):
        ...
        } else if (isNumber((ref = arg0.w) != null ? ref : arg0.width, (ref1 = arg0.h) != null ? ref1 : arg0.height)) {
          wid = (ref2 = arg0.w) != null ? ref2 : arg0.width;
          hgt = (ref3 = arg0.h) != null ? ref3 : arg0.height;
          return new Rect(p0.x, p0.y, p0.x + wid, p0.y + hgt);
        } else {
          return new Rect(p0.x, p0.y, p0.x, p0.y);
        }
        break;
      default:
