  ...
  defProp({
    'real, x': {
      ...
      set: function(new_real) {
        var ref;
        return ref = this.asPoint().x_(new_real).asPolar(), this.rho = ref.rho, this.theta = ref.theta, ref;
      }
    },
    'imag, y': {
      get: (function() {
      ...
      set: function(new_imag) {
        var ref;
        return ref = this.asPoint().y_(new_imag).asPolar(), this.rho = ref.rho, this.theta = ref.theta, ref;
      }
    },
    magnitude: {
      get: function() {
