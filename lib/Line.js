...
LineSegment = (function() {
  ...
  LineSegment.prototype.splitN = function(numberOfPieces) {
    ...
    tts = (function() {
      var _i, _results;
      _results = [];
      for (tt = _i = nn; nn > 0 ? _i <= 1 : _i >= 1; tt = _i += nn) {
        _results.push(tt);
      }
      return _results;
    })();
  ...
  LineSegment.prototype.split = function() {
    var p0, p1, tt, tts, _i, _len, _results;
    tts = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    tts = util.flatten(tts);
    if (!(__indexOf.call(tts, 1) >= 0)) {
      tts.push(1);
    }
    _results = [];
    for (_i = 0, _len = tts.length; _i < _len; _i++) {
      tt = tts[_i];
      if (!(tt > 0)) {
        continue;
      }
      ...
      p1 = this.pointAt(tt);
      _results.push(new this.constructor(p0, p1));
    }
    return _results;
  };

  LineSegment.prototype.asPath = function(maxPointSpacing) {
    var nn, segmentCount, tt, tts, _i, _len, _results;
    segmentCount = this.length / maxPointSpacing;
    nn = 1 / Math.max(1, segmentCount);
    tts = (function() {
      var _i, _ref, _results;
      _results = [];
      for (tt = _i = 0, _ref = 1 - nn; nn > 0 ? _i <= _ref : _i >= _ref; tt = _i += nn) {
        _results.push(tt);
      }
      return _results;
    })();
  ...
  LineSegment.prototype.splitFromCenter = function() {
    var l0, l1, _ref;
    _ref = this.split(0.5), l0 = _ref[0], l1 = _ref[1];
    return [l0.transpose(), l1];
  };

  LineSegment.prototype.centerAt = function(aPoint) {
    var i, l0, l1, segment, _ref;
    aPoint = Point["new"].apply(Point, arguments);
    _ref = (function() {
      var _i, _len, _ref, _results;
      _ref = this.splitFromCenter();
      _results = [];
      for (i = _i = 0, _len = _ref.length; _i < _len; i = ++_i) {
        segment = _ref[i];
        _results.push(segment.moveTo(aPoint));
      }
      return _results;
    }).call(this), l0 = _ref[0], l1 = _ref[1];
  ...
  LineSegment.prototype.envelope = function(offset, n) {
    var offsetLine, offsetTT, segment, segments, _i, _len, _results;
    if (offset == null) {
      offset = 3;
    }
    if (n == null) {
